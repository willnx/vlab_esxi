...
DEFINED = OrderedDict([
            ('VLAB_ESXI_LOG_LEVEL', environ.get('VLAB_ESXI_LOG_LEVEL', 'INFO')),
            ...
            ('VLAB_MESSAGE_BROKER', environ.get('VLAB_MESSAGE_BROKER', 'esxi-broker')),
            ('VLAB_URL', environ.get('VLAB_URL', 'https://localhost')),
            ('VLAB_ESXI_IMAGES_DIR', environ.get('VLAB_ESXI_IMAGES_DIR', '/images')),
