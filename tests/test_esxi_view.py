...
class TestESXiView(unittest.TestCase):
    ...
    def test_v1_deprecated(self):
        """ESXiView - GET on /api/1/inf/esxi returns an HTTP 404"""
    ...
    def test_get_task(self):
        """ESXiView - GET on /api/2/inf/esxi returns a task-id"""
        resp = self.app.get('/api/2/inf/esxi',
                            headers={'X-Auth': self.token})
    ...
    def test_get_task_link(self):
        """ESXiView - GET on /api/2/inf/esxi sets the Link header"""
        resp = self.app.get('/api/2/inf/esxi',
                            headers={'X-Auth': self.token})

        task_id = resp.headers['Link']
        expected = '<https://localhost/api/2/inf/esxi/task/asdf-asdf-asdf>; rel=status'

        self.assertEqual(task_id, expected)

    def test_post_task(self):
        """ESXiView - POST on /api/2/inf/esxi returns a task-id"""
        resp = self.app.post('/api/2/inf/esxi',
                             headers={'X-Auth': self.token},
    ...
    def test_post_task_link(self):
        """ESXiView - POST on /api/2/inf/esxi sets the Link header"""
        resp = self.app.post('/api/2/inf/esxi',
                             headers={'X-Auth': self.token},
                             json={'network': "someLAN",
                                   'name': "myESXiBox",
    ...
    def test_delete_task(self):
        """ESXiView - DELETE on /api/2/inf/esxi returns a task-id"""
        resp = self.app.delete('/api/2/inf/esxi',
                               headers={'X-Auth': self.token},
                               json={'name' : 'myESXiBox'})
    ...
    def test_delete_task_link(self):
        """ESXiView - DELETE on /api/2/inf/esxi sets the Link header"""
        resp = self.app.delete('/api/2/inf/esxi',
                               headers={'X-Auth': self.token},
                               json={'name' : 'myESXiBox'})
    ...
    def test_image(self):
        ...
        resp = self.app.get('/api/2/inf/esxi/image',
                            headers={'X-Auth': self.token})
